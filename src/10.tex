...
\todo{assemblery, kontigy, superkontig}

\section{Formálne definície a označenia}
\todo{narabanie so stringami; oznacenie substringu pomocou [], indexovanie stringov od 0, mozno presunut sem substitucnu editacnu vzdialenost?}
...
\todo{chcem viac o zarovnavaniach ? globalne zarovnanie, skorovanie atd. mozno biologicka motivacia, naco su dobre reverzne komplementy}
